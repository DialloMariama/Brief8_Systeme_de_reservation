                ...
                <div class="card-body">
                    <form method="post" action="/evenement/ajoute" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="date_limite_inscription"  placeholder="Entrer la date limite d'inscription" name="date_limite_inscription">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="date_evenement"  placeholder="Entrer la date de l'evenement" name="date_evenement">
                        </div>
                        <div class="form-group">
